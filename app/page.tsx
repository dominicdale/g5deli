...
export default function Home() {
  return (
    <main className="overflow-x-hidden bg-[#fffdf5] text-[#245b3b]">
      <section id="top" className="relative min-h-[710px] overflow-hidden bg-[#f6c945] px-5 pb-14 pt-5 sm:px-8 lg:min-h-[740px] lg:px-12">
        ...
        <nav className="relative z-10 mx-auto flex max-w-7xl items-center justify-between" aria-label="Main navigation">
          <a href="#top" className="group flex items-center gap-3" aria-label="G5 Deli home">
            <span className="line-mark line-mark--cup shrink-0 text-[#245b3b]" aria-hidden />
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-12 pt-16 lg:grid-cols-[1.02fr_0.98fr] lg:pt-24">
          ...
          <div className="relative mx-auto w-full max-w-[640px] lg:ml-auto">
            <div className="relative aspect-[1.16] overflow-hidden rounded-[2.4rem] border-[7px] border-[#245b3b] bg-[#fffdf5] shadow-[12px_12px_0_#245b3b] rotate-1">
      ...
      <section id="menu" className="relative border-y-4 border-[#245b3b] bg-[#fffdf5] px-5 py-20 sm:px-8 lg:px-12 lg:py-28">
      ...
      <section id="catering" className="relative overflow-hidden bg-[#245b3b] px-5 py-20 text-[#fffdf5] sm:px-8 lg:px-12 lg:py-28">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.88fr_1.12fr] lg:items-center">
          <div className="text-[#fffdf5]">
            <p className="eyebrow text-[#f6c945]">Made for sharing</p>
            <h2 className="mt-4 text-[clamp(3rem,5vw,5.5rem)] font-black leading-[0.88] tracking-[-0.075em]">Catering &amp; platters, sorted.</h2>
            <p className="mt-6 max-w-lg text-lg leading-relaxed text-white/80">Feeding the office, organising a family get-together, or planning a special afternoon? Let us put together a generous spread that feels like G5.</p>
            <a href="tel:+441414182999" className="mt-8 inline-block rounded-full bg-[#f6c945] px-6 py-4 text-sm font-black text-[#245b3b] shadow-[4px_4px_0_#fffdf5] transition hover:-translate-y-1">Call to plan your platter</a>
          </div>
          <div className="relative rounded-[2rem] bg-[#f6c945] p-5 text-[#245b3b] shadow-[10px_10px_0_#8dc63f] sm:p-7">
      ...
      <section id="about" className="relative bg-[#8dc63f] px-5 py-20 text-[#245b3b] sm:px-8 lg:px-12 lg:py-28">
        ...
        <div className="relative mx-auto grid max-w-7xl gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          ...
          <div className="grid gap-3">
            {reasons.map(([title, copy], index) => <div key={title} className="flex gap-5 rounded-2xl border-2 border-[#245b3b] bg-[#fffdf5]/80 p-5 shadow-[4px_4px_0_#245b3b] sm:p-6"><span className="grid h-10 w-10 shrink-0 place-items-center rounded-full bg-[#245b3b] text-sm font-black text-[#f6c945]">0{index + 1}</span><div><h3 className="text-xl font-black tracking-[-0.04em]">{title}</h3><p className="mt-1 leading-relaxed text-[#245b3b]/75">{copy}</p></div></div>)}
          </div>
        </div>
      </section>

      <section id="visit" className="border-t-4 border-[#245b3b] bg-[#fffdf5] px-5 py-20 sm:px-8 lg:px-12 lg:py-28">
      ...
      <section className="relative h-[440px] w-full overflow-hidden border-y-4 border-[#245b3b] bg-[#245b3b] sm:h-[520px]" aria-label="Map showing G5 Deli location">
        <div className="absolute left-5 top-5 z-10 rounded-2xl bg-[#f6c945] px-5 py-4 shadow-[4px_4px_0_#fffdf5] sm:left-8 sm:top-8"><p className="eyebrow text-[#245b3b]">Find G5 Deli</p><p className="mt-1 font-black">158 Crown Street, Gorbals</p></div>
